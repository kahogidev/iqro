...
<div class="d-flex align-items-center gap-10 justify-content-center">
    ...
    <a href="{$assignUrl}" class="bg-info-focus bg-hover-info-200 text-info-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" title="O‘quvchi biriktirish"> 
        <iconify-icon icon="mdi:account-multiple-plus-outline" class="menu-icon"></iconify-icon>
    </a>

    <!-- Edit Button -->
    <a href="update?id={$model->id}" class="bg-success-focus text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" title="Tahrirlash"> 
